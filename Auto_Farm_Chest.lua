...
if i:FindFirstChild("Mascara Cat Hub_Purple_UI") then
	i.HNC_Purple_UI:Destroy();
end;
local B = Instance.new("ScreenGui");
B.Name = "Mascara Cat Hub_Purple_UI";
...
E.Text = "Mascara Cat Hub - Auto Collect Chest";
...
local function m(q)
	...
	i.Name = "Mascara Cat Hub_FastAttack_Label";
	i.Adornee = U;
	i.AlwaysOnTop = true;
...
local function R()
	...
	q.Name = "Mascara Cat Hub_Hub_HopUI";
